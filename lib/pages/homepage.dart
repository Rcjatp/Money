...
import 'package:moneymanager/controllers/db_gelper.dart';
import 'package:moneymanager/pages/add_transaction.dart';
import 'package:moneymanager/pages/models/transaction.dart';
import 'package:moneymanager/pages/settings.dart';
import 'package:moneymanager/pages/widgets/comfirm_dialog.dart';
import 'package:moneymanager/pages/widgets/info_snackbar.dart';
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                color: CustomColors.primaryMaterialColor[800],
                              ),
                              maxLines: 1,
                            ),
                          ),
...
//
  ...
  Widget expenseTile(int value, String note, DateTime date, int index) {
    return InkWell(
      splashColor: CustomColors.primaryMaterialColor[400],
      onTap: () {
      ...
      onLongPress: () async {
        ...
        if (answer != null && answer) {
          await dbHelper.daleteData(index);
          setState(() {});
        }
      },
      child: Container(
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: index == 3 ? CustomColors.primaryColor : Colors.white,
              ),
              alignment: Alignment.center,
              child: Text(
                months[now.month - 3],
                style: TextStyle(
                  ...
                  color: index == 3 ? Colors.white : CustomColors.primaryColor,
                ),
              ),
            ),
          ),
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: index == 2 ? CustomColors.primaryColor : Colors.white,
              ),
              alignment: Alignment.center,
              child: Text(
                months[now.month - 2],
                style: TextStyle(
                  fontSize: 20.0,
                  fontWeight: FontWeight.w600,
                  color: index == 2 ? Colors.white : CustomColors.primaryColor,
                ),
              ),
            ),
          ),
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: index == 1 ? CustomColors.primaryColor : Colors.white,
              ),
              alignment: Alignment.center,
              child: Text(
                months[now.month - 1],
                style: TextStyle(
                  fontSize: 20.0,
                  fontWeight: FontWeight.w600,
                  color: index == 1 ? Colors.white : CustomColors.primaryColor,
                ),
              ),
            ),
          ),
